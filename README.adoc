...
Make sure to link both packages with -fPIC. For example, add -fPIC flags within scattered2Dinterpolator/nn-c/nn/CUSTOMISE (same for csa-c), and to ./mmg/mmg/build/configure.sh (see http://elmerfem.org/forum/viewtopic.php?t=7246)
